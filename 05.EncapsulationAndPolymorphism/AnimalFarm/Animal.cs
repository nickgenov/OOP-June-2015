    ...
    public abstract class Animal
    {
        ...
        public string Name
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentException("Name cannot be null, whitespace or an empty string", "Name");
                }
                this.name = value;
            }
        }
        ...
        public int Age
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException("Age", "Age must be in the range [0...15].");
                }
                this.age = value;
            }
        }
